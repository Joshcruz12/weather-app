...
import backgroundColors from './Data/backgrounds'
...
const WeatherCard = () => {
    ...
    const [bg , setBg] = useState({backgroundColors});
    ...
    //Changes the background-image depending on the weather 
    document.body.style= `background : ${backgroundColors["hot"]}`
   /*  const changeBackground = () => {
        setBg(bg[weather.weather[0].main]);
 */
        /* switch (weather.weather[0].main) {
            case "Clear":
                setBg(backgroundColors[weather.weather[0].main]);
                break

            case "Clouds":
                setBg(backgroundColors.cloudy);
                break
            case "Fog":
                setBg(backgroundColors.foggy);
                break
            case "Rain":
                setBg(backgroundColors.rainy);
                break
            case "Snow":
                setBg(backgroundColors.snowy);
                break
            case "ThuderStorm":
                setBg(backgroundColors.stormy);
                break
            case "Wind":
                setBg(backgroundColors.windy);
                break
            case "Hot":
                setBg(backgroundColors.hot);
                break
            case "Cold":
                setBg(backgroundColors.cold);
                break
            case "Night":
                setBg(backgroundColors.night);
                break
            default:
                setBg(backgroundColors.clear);
        } */
  /*  */
